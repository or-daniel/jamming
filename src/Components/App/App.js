...
class App extends React.Component {
    constructor(props) {
        ...
        this.isLoggedIn = Spotify.checkIfLogged();
        this.addTrack = this.addTrack.bind(this);
        this.removeTrack = this.removeTrack.bind(this);
        this.updatePlaylistName = this.updatePlaylistName.bind(this);
        this.savePlaylist = this.savePlaylist.bind(this);
        this.search = this.search.bind(this);
        this.typingFirstTime = this.typingFirstTime.bind(this);
    }
    ...
    typingFirstTime(boolean) {
        this.setState({
            searchBarValue: boolean
        })
    }
    ...
    render() {
        ...
        <div className="App">
          ...
          <div>
            <Popup show={!this.isLoggedIn && this.state.searchBarValue ? true : false} getToken={Spotify.getAccessToken}>
                    <h2>Connect your Spotify account</h2>
            </Popup>
            <SearchBar onSearch={this.search} isFirstTyping={this.typingFirstTime}/>
